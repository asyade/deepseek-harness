...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/lsp/lsp-diagnostics': { kind: 'indirect', reason: 'The provider registry delegates model rendering to dsh-tool-lsp-diagnostics.' },
  'packages/lsp/lsp-stdio-diagnostics': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-lsp-diagnostics.' },
