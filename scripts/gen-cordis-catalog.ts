...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LspDiagnostic: 'lsp.md',
  LspDiagnosticsProvider: 'lsp.md',
  LspDiagnosticsProviderId: 'lsp.md',
  LspDiagnosticsRequest: 'lsp.md',
  LspDiagnosticsSnapshot: 'lsp.md',
  LspDiagnosticsService: 'lsp.md',
