...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LspProvider: 'lsp.md',
  LspDiagnosticsProvider: '../../packages/lsp/lsp-diagnostics/README.md',
  LspDiagnosticsRequest: '../../packages/lsp/lsp-diagnostics/README.md',
  LspDiagnosticsSnapshot: '../../packages/lsp/lsp-diagnostics/README.md',
